...
Bsoft TMS segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **Bsoft (Bsoft Internetworks / nstech)** | BR | transportation management system API (data provider) |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [bsoft@mcp.ai](mailto:bsoft@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
